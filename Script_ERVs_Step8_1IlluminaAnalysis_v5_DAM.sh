...
#                       Subtask: 8.1 ILLUMINA DATA v5 (DAM)           #
...
reads=/common/WORK/SCHOOL2016/Data/ERVs/Damona/

##Step 2: create a list of the .bam files containing the illumina reads 
ls ${reads}*.bam > bamfiles_DAM.txt
echo "bamfiles_DAM.txt has been created. Look in this path: /common/WORK/SCHOOL2016/students/alicia00/Step7/"
bamfiles=/common/WORK/SCHOOL2016/students/alicia00/Step7/bamfiles_DAM.txt
...
### bash Script_ERVs_Step8_1IlluminaAnalysis_v5_DAM.sh > DAM_outputfile.txt 2> DAM_errorsfile.txt
