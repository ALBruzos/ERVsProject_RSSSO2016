...
#                       Subtask: 8.1 ILLUMINA DATA v3 (LIC)           #
...
reads=/common/WORK/SCHOOL2016/Data/ERVs/LIC/

##Step 2: create a list of the .bam files containing the illumina reads 
ls ${reads}*.bam > bamfiles_LIC.txt
echo "bamfiles_LIC.txt has been created. Look in this path: /common/WORK/SCHOOL2016/students/alicia00/Step7/"
bamfiles=/common/WORK/SCHOOL2016/students/alicia00/Step7/bamfiles_LIC.txt
...
### bash Script_ERVs_Step8_1IlluminaAnalysis_v3_LIC.sh > LIC_outputfile.txt 2> LIC_errorsfile.txt
