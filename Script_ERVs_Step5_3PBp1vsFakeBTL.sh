...
$BWA mem -t 6 -x pacbio /common/WORK/SCHOOL2016/Data/ERVs/refs/FakeReferenceForBLTR1_ERV.fa $p1data > PB_p1_Fake_alicia.sam

#Step 2: Converting the sam file to bam
$samtools view -@ 6 -b PB_p1_Fake_alicia.sam > PB_p1_Fake_alicia.bam

#Step 3: Sorting with samtools
$samtools sort -@ 6 -T /common/tmp/PB_p1_Fake_alicia.sorted -o PB_p1_Fake_alicia.sorted.bam PB_p1_Fake_alicia.bam
