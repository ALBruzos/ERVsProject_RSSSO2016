...
BTLref=/common/WORK/SCHOOL2016/Data/ERVs/refs/BTLTR1_con5.fa
...
##Step 4: Create two for loops to apply the following steps to BTL...
	...
	do
		...
		if [ "${FILENAME_file}" == "" ]
			...
			then
				...
				${BWA} mem -t 6 ${BTLref} ${FILENAME_file}.fq > ${FILENAME_file}.aligned.sam
...
### bash Script_ERVs_Step8_1IlluminaAnalysis_v6_BBB_BTL.sh > BBB_outputfile.txt 2> BBB_errorsfile.txt
