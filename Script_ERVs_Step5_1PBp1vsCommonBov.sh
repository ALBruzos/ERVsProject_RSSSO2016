...
#  Subtask: BTL alignment and analysis for dataset PB_LIC_p1_2016.fq  #
...
$BWA mem -t 6 -x pacbio /common/WORK/SCHOOL2016/Data/ERVs/refs/Common_Bov_ERV.fa $p1data > PB_p1_CommonBob_alicia.sam

#Step 2: Converting the sam file to bam
$samtools view -@ 6 -b PB_p1_CommonBob_alicia.sam > PB_p1_CommonBob_alicia.bam

#Step 3: Sorting with samtools
$samtools sort -@ 6 -T /common/tmp/PB_p1_CommonBob_alicia.sorted -o PB_p1_CommonBob_alicia.sorted.bam PB_p1_CommonBob_alicia.bam
